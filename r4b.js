...
scene.background = new THREE.Color(0x5566dd);
...
resistor.children[1].visible = false;
...
resistor.children[2].add(fatLine4);
...
resistor5b.innerHTML = 'ตัวต้านทาน 4 แถบ';
    ...
    if ( intersects.length > 0 ) {
        ...
        switch (clickObj.object.name) {
            ...
            case "r4c9":
                ...
                break;
            case "r4cA":
                resistor.children[2].material.color.set(0xFFD700);
                ...
                break;
            case "r4cB":
                resistor.children[2].material.color.set(0xC0C0C0);
